...
def main():
    ...
    parser.add_argument('--rerank_graph_mode', type=bool, default=None, help='Whether to use reranking for graph construction or not.')
    parser.add_argument('--rerank_threshold', type=float, default=None, help='Setting to use reranking value.')
    parser.add_argument('--rerank_model_name', type=str, default=None, help='Choice to use reranking model name.')
    ...
    config = BaseConfig(
        ...
        retrieval_top_k=200,
        linking_top_k=5, # 這邊是graph_rag最終會抓取的節點數 論文預設為5 為了驗證dynamic_top_k 我先改20 
        max_qa_steps=3,
        qa_top_k=5,
        ...
        rerank_graph_mode=args.rerank_graph_mode,
